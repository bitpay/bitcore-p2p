...
Inventory.forBlockSegwit = function(hash) {
  return Inventory.forItem(Inventory.TYPE.BLOCK_SEGWIT, hash);
};
...
Inventory.forTransactionSegwit = function(hash) {
  return Inventory.forItem(Inventory.TYPE.TX_SEGWIT, hash);
};
...
Inventory.TYPE.BLOCK_SEGWIT = 0x40000002;
Inventory.TYPE.TX_SEGWIT = 0x40000001;
Inventory.TYPE_NAME = [
  'ERROR',
  'TX',
  'BLOCK',
