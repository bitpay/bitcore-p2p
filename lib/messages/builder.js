...
function builder(options) {
  ...
  exported.inventoryCommands.forEach(function(command) {
    ...
    // add forTransactionSegwit methods
    exported.commands[command].forTransactionSegwit = function forTransactionSegwit(hash) {
      return new exported.commands[command]([Inventory.forTransactionSegwit(hash)]);
    };
    ...
    // add forBlockSegwit methods
    exported.commands[command].forBlockSegwit = function forBlockSegwit(hash) {
      return new exported.commands[command]([Inventory.forBlockSegwit(hash)]);
    };
